...
public class UserController {
    ...
    User newUser) throws UserDaoException {
        return userDao.createUser(newUser);
    }

    @GET
    public @ResponseBody
    List<User> retriveAllUsers() throws UserDaoException {
    ...
    @Path("{username}")
    public @ResponseBody
    User retrieveUserByUsername(@PathParam("username")
    String username) throws UserDaoException {
    ...
    @Path("{username}")
    public @ResponseBody
    User updateUserByUsername(@RequestBody
    UpdateField updateField, @PathParam("username")
    String username) throws UserDaoException {
    ...
    @Path("{username}")
    public @ResponseBody
    User delete(@PathParam("username")
    String username) throws UserDaoException {
